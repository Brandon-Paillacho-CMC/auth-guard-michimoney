        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const res = yield (0, rxjs_1.firstValueFrom)(this.http.post(this.config.introspectionUrl, params).pipe((0, rxjs_1.catchError)((error) => {
                    ...
                    console.log(error);
                    return (0, rxjs_1.throwError)(() => { var _a; return new common_1.HttpException(`Error: ${JSON.stringify((_a = error.response) === null || _a === void 0 ? void 0 : _a.data)}`, common_1.HttpStatus.UNAUTHORIZED); });
                })));
                if (!res.data.active) {
